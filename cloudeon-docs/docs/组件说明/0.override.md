...
| 系统    | HelmController   | Deployment | 0.16.5                |                 | Helm控制器，带来CloudEon对于HelmChart资源的支持                                             |
...
| 业务    | ZooKeeper        | Deployment | 3.7.1                 |                 | 分布式协调服务与一致性解决方案                                                                |
...
| 业务    | Doris            | Deployment | 2.1.11                |                 | 基于 MPP 架构的高性能、实时分析型数据库                                                         |
...
| 业务    | MinIO            | Deployment | <span title="2021-04-22T15-44-28Z">`2021-...`</span> |                 | 支持主流的云原生容器化部署、兼容S3的高性能分布式对象存储系统                                                |
