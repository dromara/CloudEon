...
//                client.pods().withName(podName).delete();
    ...
    public void job() throws FileNotFoundException, InterruptedException {
        ...
        VolumeMount mount = new VolumeMountBuilder()
                .withName("config-volume")
                .withMountPath("/container/conf")
                .build();


        Container container = new ContainerBuilder()
                .withName("init")
                .withImage("openjdk:8-jdk-alpine")
                .withCommand("sh", "-c", "/container/conf/test.sh")
        ...
        Job job = new JobBuilder()
                ...
                .withNewSpec()
                .withVolumes(volume)
                .withNodeSelector(Collections.singletonMap("kubernetes.io/hostname", "bar"))
        ...
        List<Pod> pods = client.pods()
                .inNamespace("default")
                .withLabel("job-name", "init-work-dir")
                .list().getItems();
        ...
        Watcher<Job> watcher = new Watcher<Job>() {
            ...
            public void eventReceived(Action action, Job job) {
                System.out.println("job watch action: " + action);
        ...
        try (LogWatch logWatch = client.pods()
            ...
            try (BufferedReader reader = new BufferedReader(new InputStreamReader(logWatch.getOutput()))) {
                ...
                while ((line = reader.readLine()) != null) {
                    System.out.println(line);  // You can replace this with your desired logging mechanism
                }
            } catch (IOException e) {
                e.printStackTrace();
            } finally {
