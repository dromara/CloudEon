...
@NoArgsConstructor
public class InitYARNDirOnHDFSTask extends BaseUdhTask {
    ...
    public void internalExecute() {
        ...
        // todo 能捕获到执行日志吗？
        String cmd = String.format("sudo docker  run --net=host -v /opt/udh/%s/conf:/opt/udh/%s/conf  %s sh -c \"  /opt/udh/%s/conf/init-yarn-hdfs-dir.sh \"   ",
