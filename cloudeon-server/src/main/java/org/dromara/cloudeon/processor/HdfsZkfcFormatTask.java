...
public class HdfsZkfcFormatTask extends BaseCloudeonTask {
    ...
    public void internalExecute() {
        ...
        // 启动K8S job
        String jobCmd = String.format("yes Y| hdfs --config  /opt/edp/%s/conf zkfc -formatZK",serviceName);
        ...
        K8sUtil.runJob(namespace,"hdfs-zkfc-format", kubeClient, volumeMounts, stackServiceEntity.getDockerImage(), jobCmd, log, nodeEntity.getHostname());
