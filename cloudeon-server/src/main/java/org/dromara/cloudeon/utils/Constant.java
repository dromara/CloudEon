...
public class Constant {
    public static final String VERTX_COMMAND_ADDRESS = "command.adrress";
    ...
    public static final Integer AdminUserId=1000;
    ...
    public static final String KYLIN_SERVICE_NAME = "KYLIN";
