...
export SPARK_HISTORY_OPTS="$SPARK_HISTORY_OPTS -XX:+PrintGCDetails -XX:+PrintGCDateStamps -Xloggc:/opt/edp/${service.serviceName}/log/gc-spark-historyserver.log -Dcom.sun.management.jmxremote -Dcom.sun.management.jmxremote.authenticate=false -Dcom.sun.management.jmxremote.ssl=false -Dcom.sun.management.jmxremote.port=9924 -javaagent:/opt/jmx_exporter/jmx_prometheus_javaagent-0.14.0.jar=5554:/opt/edp/${service.serviceName}/conf/jmx_prometheus.yaml"
