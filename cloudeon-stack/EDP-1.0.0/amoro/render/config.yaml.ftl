ams:
  ...
  server-expose-host: "${localhostip}"
...
containers:
  - name: localContainer
    ...
    properties:
      export.JAVA_HOME: "/opt/jdk1.8.0_141"   # JDK environment


  - name: flinkContainer
    container-impl: com.netease.arctic.optimizer.FlinkOptimizerContainer
    properties:
      flink-home: "/home/hadoop/apache-flink/"                                     # Flink install home
#      export.JVM_ARGS: "-Djava.security.krb5.conf=/opt/krb5.conf"   # Flink launch jvm args, like kerberos config when ues kerberos
      export.HADOOP_CONF_DIR: "/home/hadoop/amoro/conf"                   # Hadoop config dir
      export.HADOOP_USER_NAME: "hadoop"                             # Hadoop user submit on yarn
      export.FLINK_CONF_DIR: "/home/hadoop/amoro/conf"                    # Flink config dir
