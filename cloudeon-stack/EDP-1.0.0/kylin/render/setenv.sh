...
export KYLIN_JVM_SETTINGS="$KYLIN_JVM_SETTINGS  -Dcom.sun.management.jmxremote -Dcom.sun.management.jmxremote.authenticate=false -Dcom.sun.management.jmxremote.ssl=false -Dcom.sun.management.jmxremote.port=9926 -javaagent:/opt/jmx_exporter/jmx_prometheus_javaagent-0.14.0.jar=5556:/home/hadoop/apache-kylin/conf/jmx_prometheus.yaml"
