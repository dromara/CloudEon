...
JAVA_OPTS="-server -Duser.timezone=$SPRING_JACKSON_TIME_ZONE -Xms1g -Xmx1g -Xmn512m -XX:+PrintGCDetails -Xloggc:/opt/edp/${service.serviceName}/log/gc-ds-worker-server.log -XX:+HeapDumpOnOutOfMemoryError -XX:HeapDumpPath=dump.hprof"




nohup java $JAVA_OPTS \
  -cp "$DS_CONF":"$DOLPHINSCHEDULER_WORKER_HOME/libs/*" \
