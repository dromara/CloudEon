...
<#--    hive.metastore.uris-->
    ...
    <@property "metastore.thrift.port" "${conf['hive.metastore.thrift.port']}"/>
    <@property "hive.metastore.uris" metastore_uri?join(",")/>
<#--处理bug:https://issues.apache.org/jira/browse/HIVE-19316-->
    <@property "hive.stats.autogather" "false"/>
<#--hiveserver2操作日志-->
    ...
    <@property "hive.server2.logging.operation.log.location" "/workspace/logs/operation_logs"/>
