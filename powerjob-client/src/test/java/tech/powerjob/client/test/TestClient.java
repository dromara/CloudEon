...
class TestClient extends ClientInitializer {
    ...
    void testFetchInstanceInfo() {
        ResultDTO<InstanceInfoDTO> res = powerJobClient.fetchInstanceInfo(486549245537550400L);
        System.out.println(res);
        Assertions.assertNotNull(res);
    }

    @Test
    void testFetchInstanceLog() {
        ResultDTO<StringPageDTO> res = powerJobClient.fetchInstanceLog(1L,488727786412834880L,1L);
        System.out.println(res);
        Assertions.assertNotNull(res);
    }
    ...
    void testFetchInstanceStatus() {
        ResultDTO<Integer> res = powerJobClient.fetchInstanceStatus(486547389071491136L);
        System.out.println(res);
        Assertions.assertNotNull(res);
    }
